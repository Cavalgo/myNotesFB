...
//Optional try catch. Just so that you are aware that the method get note will throw an exception if note notfound. Remember, in this case we don't need to rethrow it as it would do it automatically
    try {
